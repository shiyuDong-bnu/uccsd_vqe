"""
A manual implement of transform integral into 
openfermion order 
in psi4 the order is g_{pqrs} a^\dagger_r a^\dagger_s a_q a_p
in openfermion the order is  g_{pqrs} a^\dagger_p a^\dagger_q a_r a_s
"""
